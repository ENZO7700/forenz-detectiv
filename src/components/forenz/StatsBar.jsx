...
export default function StatsBar({
  ...
  return (
    <div
      ...
      className="fixed z-30 right-3 lg:right-4 bottom-[calc(3.5rem+max(0.5rem,env(safe-area-inset-bottom,0px))+0.5rem)] lg:bottom-4 flex flex-col items-end gap-2 pointer-events-none"
    >
      <AnimatePresence>
        {open && (
          <motion.div
